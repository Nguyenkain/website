<ul class="nav nav-pills nav-stacked active">
	...
	<?php if(Yii::app()->controller->id == 'creatures'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'ho'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'bo'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'nhom'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'author'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'coordinations'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update' || Yii::app()->controller->action->id == 'view')):  ?>
