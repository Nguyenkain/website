...
<?php echo $form->dropDownList(CreaturesProvincesRelation::model(), 'province_id', CHtml::listData(CreaturesProvincesRelation::model()->findAll(array('order' => 'creature_id')), 'province_id', 'creature_id'),
