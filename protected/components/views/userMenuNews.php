<ul class="nav nav-pills nav-stacked active">
	...
	<?php if(Yii::app()->controller->id == 'categories'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'news'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update')):  ?>
