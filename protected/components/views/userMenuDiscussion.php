<ul class="nav nav-pills nav-stacked active">
	...
	<?php if(Yii::app()->controller->id == 'threads'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update')):  ?>
	...
	<?php if(Yii::app()->controller->id == 'reportTypes'  && (Yii::app()->controller->action->id == 'admin' || Yii::app()->controller->action->id == 'update')):  ?>
	<li class="active"><?php echo CHtml::link('Quản lý loại báo cáo',array('reportTypes/admin')); ?>
	</li>
	<?php else: ?>
	<li><?php echo CHtml::link('Quản lý loại báo cáo',array('reportTypes/admin')); ?></li>
	<?php endif;?>
